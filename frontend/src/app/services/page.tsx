...
const services = [
  ...
  { icon: Zap, title: 'Control Systems Integration', slug: 'control-systems', image: 'control-systems.png', desc: 'End-to-end integration of control and automation systems including SCADA, DCS, and PLC systems for optimal plant performance and safety.', highlights: ['SCADA Systems', 'DCS Integration', 'PLC Programming', 'HMI Development'] },
  { icon: Wrench, title: 'Maintenance Services', slug: 'maintenance', image: 'maintenance.png', desc: 'Planned and corrective maintenance programs for oil and gas equipment to maximize uptime and extend the operational lifecycle of critical assets.', highlights: ['Preventive Maintenance', 'Corrective Maintenance', 'Shutdown/Turnaround', 'Asset Management'] },
  ...
  { icon: Bot, title: 'Instrumentation & Automation', slug: 'automation', image: 'instrumentation-automation.png', desc: 'Design and deployment of cutting-edge instrumentation and automation solutions to improve process efficiency and ensure operational safety.', highlights: ['Flow Measurement', 'Level & Pressure Instruments', 'Safety Instrumented Systems', 'Fire & Gas Detection'] },
